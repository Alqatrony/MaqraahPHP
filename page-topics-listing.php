 ...
 * Description: Page template for displaying multiple topics
 */
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-12 mt-3 mx-auto">
                    ...
                    <div class="custom-block custom-block-topics-listing bg-white shadow-lg mb-5">
                        <div class="d-flex">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/topics/undraw_Remote_design_team_re_urdx.png"
                                 class="custom-block-image img-fluid" alt="Web Design">
                    ...
                    <div class="custom-block custom-block-topics-listing bg-white shadow-lg mb-5">
                        <div class="d-flex">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/topics/undraw_online_ad_re_ol62.png"
                                 class="custom-block-image img-fluid" alt="Advertising">
                    ...
                    <div class="custom-block custom-block-topics-listing bg-white shadow-lg mb-5">
                        <div class="d-flex">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/topics/undraw_Podcast_audience_re_4i5q.png"
                                 class="custom-block-image img-fluid" alt="Podcast">
                ...
                <div class="col-lg-6 col-md-6 col-12 mt-3 mb-4 mb-lg-0">
                    <div class="custom-block bg-white shadow-lg">
                        <a href="<?php echo home_url('/topics-detail/'); ?>">
                            ...
                            <img src="<?php echo get_template_directory_uri(); ?>/images/topics/undraw_Finance_re_gnv2.png"
                    ...
                    <div class="custom-block custom-block-overlay">
                        <div class="d-flex flex-column h-100">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/businesswoman-using-tablet-analysis.jpg"
                                 class="custom-block-image img-fluid" alt="Finance">
